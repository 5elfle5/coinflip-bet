...
class Program {
    ...
    constructor(idl, provider = (0, provider_js_1.getProvider)(), coder, getCustomResolver) {
        ...
        // Dynamic namespaces.
        const [rpc, instruction, transaction, account, simulate, methods, views] = index_js_2.default.build(camelCasedIdl, this._coder, this._programId, provider, getCustomResolver);
        this.rpc = rpc;
