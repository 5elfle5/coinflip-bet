...
exports.BaseWalletDisconnectButton = void 0;
...
function BaseWalletDisconnectButton(_a) {
    var { children, disabled, labels, onClick } = _a, props = __rest(_a, ["children", "disabled", "labels", "onClick"]);
    const { buttonDisabled, buttonState, onButtonClick, walletIcon, walletName } = (0, wallet_adapter_base_ui_1.useWalletDisconnectButton)();
...
exports.BaseWalletDisconnectButton = BaseWalletDisconnectButton;
